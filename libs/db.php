...
function CheckLicense($licenseKey)
{
    ...
    $r = PostMessageToServer("nwe.funmayhem.com", "/check_license.php",
        "license=$licenseKey&server=" . $_SERVER['HTTP_HOST'] . "&sip=" . $_SERVER['SERVER_ADDR']);
    if (trim($r) == "true") {
        $_SESSION["engine_validity"] = true;
        return true;
    }
    $_SESSION["engine_validity"] = false;
    return false;
}
