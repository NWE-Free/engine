...
echo "var actionWizard=[";

$result = $db->Execute("select id,name, code,label_1,param_1,label_2,param_2,label_3,param_3,label_4,param_4,label_5,param_5 from wizard_actions order by name");
$row = 0;
while (!$result->EOF) {
    if ($row != 0) {
        echo ",";
